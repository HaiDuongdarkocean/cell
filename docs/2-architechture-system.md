...
|| `features/dictionaryPopup/ui/useDictionaryPanel.ts` | useDictionaryLookup, runtime, messages, translation | DictionaryPanelView | Hook: composes useDictionaryLookup; adds translate, audio, image, tab, sendToCard prefill |

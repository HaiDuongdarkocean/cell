...
│   └── dictionaryPopup/  # Popup Dictionary (spec §9, ADR-037) — types, schema; worker/lookupWorker, lookupWorkerHandler, workerFactory, phraseIndexLoader, resourcePriority; logic/lruCache, lookupOrchestrator; trigger/subtitleTriggerController; services/wordStatusStore; plugins/languagePlugin, englishPlugin, chinesePlugin, fallbackPlugin, pluginRegistry

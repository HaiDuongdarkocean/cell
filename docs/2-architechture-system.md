...
│   │       └── ui/HostManagerSheet.tsx  # **T14 (planned)**: React component — renders SubtitleManagerPanel as bottom sheet on host page (cross-frame manager projection)
│   │       └── ui/HostManagerSheet.module.css  # **T14 (planned)**: Styles for host sheet — 75vh bottom sheet, slide-up animation
...
│   │   ├── Button.tsx + .module.css        # Button atom: primary/primarySubtle/secondary/outline/ghost/destructive/link, sm/md/lg, horizontal/vertical orientation, active toggle state, loading, disabled
...
| `shared/ui/Button.tsx` | — | App.redesigned, ResourceCard, Dropzone, ImportProgress, DeleteConfirmModal, ResourcesPanel, ThemePanel, ThemeImportExport, SelectionBar, SubtitleManagerFooter | Button atom: primary/primarySubtle/secondary/outline/ghost/destructive/link, sm/md/lg, horizontal/vertical orientation, active toggle state, loading, disabled |
...
| `shared/ui/FooterBar.tsx` | — | SubtitleManagerFooter | Generic bottom navigation bar (ZaloPay/iOS tab bar/M3 pattern): slots prop, equal-width, flat, soft shadow separator, height=content |
...
| `HostManagerSheet` | `features/subtitle/ui/HostManagerSheet.tsx` | (props) → ReactElement | installManagerSheetBridge | **T14 (planned)**: React component — renders SubtitleManagerPanel as bottom sheet on host page (cross-frame manager projection); 75vh max height, slide-up animation |

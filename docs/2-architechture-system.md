...
│   └── dictionaryPopup/  # Popup Dictionary (spec §9, ADR-037) — types, schema; worker/lookupWorker, lookupWorkerHandler, workerFactory, phraseIndexLoader, resourcePriority; logic/lruCache, lookupOrchestrator; trigger/subtitleTriggerController, subtitleTokenWrap; services/wordStatusStore, quickAddAssembler, quickAddHandler; ui/popupShell, popupContent, popupToolbar; plugins/languagePlugin, englishPlugin, chinesePlugin, fallbackPlugin, pluginRegistry

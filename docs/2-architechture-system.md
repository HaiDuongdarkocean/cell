...
|| `features/dictionaryPopup/ui/PopupDictionary.tsx` | shared/ui, icons, DictionaryPanelView, PopupDictionary.module.css | mountPopupDictionary | React popup shell: dialog wrapper with drag header, close, resize handle, and DictionaryPanelView content |
|| `features/dictionaryPopup/ui/PopupDictionary.test.tsx` | PopupDictionary, mock for DictionaryPanelView | — | Unit tests: dialog shell, close callback, props passed to DictionaryPanelView, inline style |
|| `features/dictionaryPopup/ui/PopupDictionary.module.css` | tokens | PopupDictionary | Popup shell layout, header, content, resize handle |

...
| `bindTokenBlock` | `features/tokenize/ui/tokenSpanRenderer.ts` | (TokenBlock, displayOptions) → void | webTokenizeController | Wrap tokens in spans, apply status/frequency classes, restore original text on unbind |

...
│   └── dictionaryPopup/  # Popup Dictionary (spec §9, ADR-037) — types, schema; worker/lookupWorker, lookupWorkerHandler, workerFactory, phraseIndexLoader, resourcePriority; logic/lruCache, lookupOrchestrator, lookupOrchestratorBenchmark; trigger/subtitleTriggerController, subtitleTokenWrap, webTriggerController; services/wordStatusStore, quickAddAssembler, quickAddHandler, sendToCreator; ui/popupShell, popupContent, popupToolbar, popupDictionaryController; plugins/languagePlugin, englishPlugin, chinesePlugin, fallbackPlugin, pluginRegistry

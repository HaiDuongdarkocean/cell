...
| `CardCreatorDialogContent` | `features/cardCreator/ui/CardCreatorDialogContent.tsx` | (state, variant, onCancel) → ReactElement | CardCreatorDialog, CardCreatorBottomSheet | **ADR-026**: Main body — alerts, card destination, preview block, fields, footer |

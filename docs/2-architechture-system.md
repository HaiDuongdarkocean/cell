...
|| `features/dictionaryPopup/ui/useCandidate.ts` | useDictionaryToolbar, runtime, wordStatusStore, wordStatusClient, buildCandidatePrefill, popupContent | CandidateView | Hook: composes useDictionaryToolbar; adds definition selection, status cycle, play TTS, and card-creator prefill |

...
│   └── tokenize/       # Tokenize on Media (ADR-047) — VDLT-Hybrid: types; logic/textTokenizer, logic/tokenizeBlock (boundary detection), logic/tokenizeCache (LRU), logic/tokenizeScheduler (idle chunk); controller/webTokenizeController, controller/subtitleTokenizeController; services/tokenizeSettingsStore, services/tokenizeStateStore; ui/tokenSpanRenderer, ui/tokenBadge, ui/tokenMiniPanel

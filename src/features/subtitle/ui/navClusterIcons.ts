...
export const NAV_CLUSTER_ICONS: Record<NavClusterIconName, string> = {
  ...
  prev: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" class="nav-cluster-icon"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.5"/><path d="M13.5 9L10.5 12L13.5 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  // next sentence — round-alt-arrow-right (circle + chevron right)
  next: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" class="nav-cluster-icon"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="1.5"/><path d="M10.5 9L13.5 12L10.5 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  // repeat — restart (loop arrow)
  repeat: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" class="nav-cluster-icon"><path d="M18.364 8.05026L17.6569 7.34315C14.5327 4.21896 9.46734 4.21896 6.34315 7.34315C3.21895 10.4673 3.21895 15.5327 6.34315 18.6569C9.46734 21.7811 14.5327 21.7811 17.6569 18.6569C19.4737 16.84 20.234 14.3668 19.9377 12.0005M18.364 8.05026H14.1213M18.364 8.05026V3.80762" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  ...
  forward: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false" class="nav-cluster-icon"><path d="M10 4.5L12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 7.89936 19.5318 4.3752 16 2.83209" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7.5 10.5L10 8.5V15.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12.5 13.75V10.25C12.5 9.2835 13.2835 8.5 14.25 8.5C15.2165 8.5 16 9.2835 16 10.25V13.75C16 14.7165 15.2165 15.5 14.25 15.5C13.2835 15.5 12.5 14.7165 12.5 13.75Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>',
};

/** Icon names that have SVG markup. */
export type NavClusterIconName = 'prev' | 'next' | 'repeat' | 'rewind' | 'forward';

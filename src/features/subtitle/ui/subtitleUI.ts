...
// FIXME: stroke 3 variant — registry has stroke 2. Extract variant when needed.
const ICONS: Record<ToastVariant, string> = {
  // FIXME: stroke 3 variant — registry has stroke 2. Extract variant when needed.
  success: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;fill:none !important"><path d="M20 6L9 17l-5-5"/></svg>`,
  // FIXME: stroke 3 variant — registry has stroke 2. Extract variant when needed.
  error: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;fill:none !important"><path d="M18 6L6 18"/><path d="M6 6l12 12"/></svg>`,
  // FIXME: stroke 3 variant — registry has stroke 2. Extract variant when needed.
  warning: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;fill:none !important"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>`,
  // FIXME: stroke 3 variant — registry has stroke 2. Extract variant when needed.
  info: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;fill:none !important"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>`,
};

...
- [x] **T4.3 Productize only proven UX patterns** [completed]
  ...
  - [x] Slice 5: productize Vocabulary capture pattern (PatternVocabularyCapture showcase + Playwright a11y/keyboard tests).
...
- [x] **T5.2 Add Design System health report**
  - [x] Adoption, drift, token, evidence, flake, bundle metrics generated by `scripts/generate-design-system-health-report.mjs`.
  - [x] Shared UI adoption 64.75% with 43 documented exceptions in `docs/design-system/HEALTH_REPORT.md`.

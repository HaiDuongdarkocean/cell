...
export const VISUAL_MATRIX: VisualCase[] = [
  ...
  },
  {
    ...
    theme: 'light',
    target: (page) => page.getByRole('button', { name: 'Disabled' }).first(),
    action: 'none',
  ...
  },
  {
    ...
    theme: 'light',
    target: (page) => page.getByRole('button', { name: 'Loading' }).first(),
    action: 'none',
  ...
  },
  {
    ...
    state: 'primary-error',
    theme: 'light',
    target: (page) => page.getByRole('button', { name: 'Error' }).first(),
    action: 'none',
